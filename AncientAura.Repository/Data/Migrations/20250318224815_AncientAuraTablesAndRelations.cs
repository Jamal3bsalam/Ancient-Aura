...
{
    /// <inheritdoc />
    public partial class AncientAuraTablesAndRelations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AncientSites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticlesPicUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookPictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Discription = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentCreator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocPictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocumentryUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Discription = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Documentries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageURLs_AncientSites_AncientSitesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoindAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentriesId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AncientSites_AncientSitesId",
                        column: x => x.AncientSitesId,
                        principalTable: "AncientSites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Reviews_Documentries_DocumentriesId",
                        column: x => x.DocumentriesId,
                        principalTable: "Documentries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Symbols_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Practices", x => new { x.SymbolId, x.AppUserId });
                    table.ForeignKey(
                        name: "FK_Practices_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Practices_Symbols_SymbolId",
                        column: x => x.SymbolId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageURLs_AncientSitesId",
                table: "ImageURLs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AncientSitesId",
                table: "Reviews",
                column: "AncientSitesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DocumentriesId",
                table: "Reviews",
                column: "DocumentriesId");

            migrationBuilder.CreateIndex(
                name: "IX_Scores_AnswerId",
                table: "Scores",
                column: "AnswerId",
                unique: true,
